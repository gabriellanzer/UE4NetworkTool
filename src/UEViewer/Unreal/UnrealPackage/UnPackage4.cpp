...
#include <UEViewer/Unreal/FileSystem/GameFileSystem.h>		// just required for next header
#include <UEViewer/Unreal/FileSystem/IOStoreFileSystem.h>	// for FindPackageById()
